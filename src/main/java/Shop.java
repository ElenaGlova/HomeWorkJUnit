public class Shop {
    public static final String[] PRODUCT = {"Молоко", "Хлеб", "Гречневая крупа"};
    public static final String[] PRODUCT_SALE = {"Шоколадка", "Чупа-чупс", "Авокадо"};
    public static final String[] ALL_PRODUCT = new String[PRODUCT.length + PRODUCT_SALE.length];
    public static final int[] PRICE = {50, 14, 80};
    public static final int[] PRICE_SALE = {100, 5, 50};
